...
extension Double {
    ...
    var MB: Measurement<UnitInformationStorage> { .init(value: self, unit: .megabytes) }
    var GB: Measurement<UnitInformationStorage> { .init(value: self, unit: .gigabytes) }
    var TB: Measurement<UnitInformationStorage> { .init(value: self, unit: .terabytes) }
    var PB: Measurement<UnitInformationStorage> { .init(value: self, unit: .petabytes) }
}
